...
public class Informes extends javax.swing.JFrame {
    ...
    public Informes() {
        try {
            initComponents();
            ArrayList<String> listaMeses = ProyectoFinal.llenarComboMeses();
            for (int n=0;n<listaMeses.size();n++) {
                cbMeses.addItem(listaMeses.get(n));
            }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Elige una fecha para generar el informe sobre ese mes:");
    ...
    private void jbGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbGuardarActionPerformed
        ...
        Calendar cal = dcFecha.getSelectedDate();
        ...
        try {
            ProyectoFinal.guardarInforme(mes);
        } catch (SQLException ex) {
            Logger.getLogger(Informes.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jbAbrirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAbrirActionPerformed
        try {
            ...
            ProyectoFinal.generarArchivoInf(mes);
        } catch (SQLException ex) {
            Logger.getLogger(Informes.class.getName()).log(Level.SEVERE, null, ex);
        }
